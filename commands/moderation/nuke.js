...
module.exports = {
  ...
  run: async (client, message, args) => {
    message.channel.send(`${message.author}` + "This CMD will made delete all message o this channel!\nIf you want to continue send [!nuke yes]")
    if(message.content.toUpperCase().includes('YES')){
